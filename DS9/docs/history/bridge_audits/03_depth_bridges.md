...
- [`../native/noesis_depth_meta_ext.cpp`](../native/noesis_depth_meta_ext.cpp)
- [`../native/noesis_depth_tracking_tensor_ext.cpp`](../native/noesis_depth_tracking_tensor_ext.cpp)
- [`../noesis/metadata/object_depth.py`](../noesis/metadata/object_depth.py)
- [`../noesis/metadata/depth_result.py`](../noesis/metadata/depth_result.py)
- [`../noesis/pipelines/hooks.py`](../noesis/pipelines/hooks.py)
- [`../pipelines/config_infer_secondary_depth_tracking_da2.template.ini`](../pipelines/config_infer_secondary_depth_tracking_da2.template.ini)
- [`../docs/history/ds8/DS8_metadata_contracts.md`](../docs/history/ds8/DS8_metadata_contracts.md)
