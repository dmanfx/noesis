...
Scope: `DS9/pipelines/nvdsinfer_*`, `DS9/config/infer.yaml`, `DS9/docs/history/ds8/DS8_testing_guide.md`, `DS9/docs/history/ds8/ds8_design_decisions.md`, plus official NVIDIA DS9 documentation. No code or config edits were made.
...
- `DS9/docs/history/ds8/DS8_testing_guide.md` records the YOLO26 fused-output contract: a single `output0`, `disable-output-host-copy=1`, and bounded top-30 mask composition.
- `DS9/docs/history/ds8/ds8_design_decisions.md` records why YOLO26-Seg was fused: avoid large proto-tensor host copies and keep mask composition on GPU.
