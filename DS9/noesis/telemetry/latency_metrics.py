...
_NVDS_LATENCY_ENV = "NVDS_ENABLE_LATENCY_MEASUREMENT"
_INPROCESS_LATENCY_ENV = "NOESIS_DS9_ENABLE_INPROCESS_LATENCY"
...
# Optional DS9 in-process Service Maker latency shim
...
class LatencyCollector:
    ...
    def __init__(self, window_sec: float = 10.0) -> None:
        ...
        self._nvds_enabled_by_env = _env_truthy(_NVDS_LATENCY_ENV, default=False)
        self._inprocess_enabled_by_env = _env_truthy(
            _INPROCESS_LATENCY_ENV, default=False
        )
        self._enabled_by_env = bool(
            self._nvds_enabled_by_env and self._inprocess_enabled_by_env
        )
        if self._nvds_enabled_by_env and not self._inprocess_enabled_by_env:
            self._disabled_reason = "ds9_inprocess_latency_disabled"
