...
"${ROOT}/scripts/build_native_ext_ds9.sh" noesis_pose_meta_ext "${ROOT}/native/noesis_pose_meta_ext.cpp"
...
"${ROOT}/scripts/build_native_ext_ds9.sh" noesis_reid_meta_ext "${ROOT}/native/noesis_reid_meta_ext.cpp"
