#!/usr/bin/env python3
"""Smoke test for MapAnything depth RPC over WebSocket (DS9 runtime)."""
...
def main() -> int:
    ...
    parser.add_argument("--no-spawn", action="store_true", help="Do not spawn ds9_runtime; assume external runtime")
