...
def main() -> int:
    ...
    parser.add_argument("--pipeline-config", default=str(DS9_ROOT / "config" / "infer.yaml"))
    parser.add_argument("--cameras-config", default=str(REPO_ROOT / "config" / "cameras.yaml"))
