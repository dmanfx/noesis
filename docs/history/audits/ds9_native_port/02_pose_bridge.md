...
- `docs/history/runtime/ds8/ds8_design_decisions.md`
...
- `docs/history/runtime/ds8/DS8_metadata_contracts.md` and
  `docs/history/runtime/ds8/ds8_design_decisions.md` record that the native
  bridge exists because Service Maker Python did not expose the required object
  user-meta surface.
