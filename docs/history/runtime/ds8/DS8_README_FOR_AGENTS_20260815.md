...
> **Historical snapshot:** DS8 is retired and the instructions below are
> non-operative. Current agents must start at `docs/README.md` and use the
> native-host DS9.1 runtime.
