...
export const LegendPanel: React.FC<{ tracks: Array<{ stable_id: number; tracker_id?: number; id_display?: string; camera_id: string }>; title?: string; }>
  = ({ tracks, title }) => {
      ...
      <div className="legend">
        {list.map(t => {
          ...
          <div key={key} className="legend-row">
            ...
            <div className="mono">ID {idDisplay}</div>
