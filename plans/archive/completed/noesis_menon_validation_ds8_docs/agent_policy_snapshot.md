# Historical agent-policy snapshot — Noesis/Menon DS8 validation

**Non-operative archive:** this file preserves instructions from the retired
DS8 workstream. It is not an `AGENTS.md`, does not define current scope or
precedence, and must not override repository or `plans/` guidance.
