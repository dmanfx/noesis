"""Build and locate the YOLO26-Pose custom parser shared library."""
...
PARSER_SRC = PARSER_DIR / "yolo26_pose_parser.cpp"
PARSER_LIB = PARSER_DIR / "libyolo26_pose_parser.so"
...
def ensure_custom_parser_lib() -> Path:
    if PARSER_LIB.exists() and PARSER_SRC.exists():
